/*
** SFMLEvents.cpp for cpp_arcade in /home/anthony/repository/cpp_arcade/SFMLEvents.cpp
**
** Made by Anthony LECLERC
** Login   <anthony.leclerc@epitech.eu>
**
** Started on  mar. avr. 04 21:44:32 2017 Anthony LECLERC
** Last update mar. avr. 04 21:44:32 2017 Anthony LECLERC
*/

#include <iostream>
#include "SFMLContext.hpp"

arcade::sfml::SFMLEvents::SFMLEvents(SFMLContext &context) :
    _refContext(context)
{}

void arcade::sfml::SFMLEvents::pollEvents()
{
  sf::Event event;
...
bool arcade::sfml::SFMLEvents::keyPressed(arcade::api::IEvents::Key id) const
{
  if (id != UNKNOWN)
...
bool arcade::sfml::SFMLEvents::mouseButtonPressed(
...
arcade::utl::Position arcade::sfml::SFMLEvents::getMousePos() const
{
